...
It is interesting to note that none of the work above employs Learning from Demonstration to learn how a robot should behave socially. LfD seems to be instead most commonly used for complex manipulation tasks \cite{argall2009survey} where the field is indeed very active. And more recently along with deep learning in self-driving cars, with very promising results. In terms of social robot behavior LfD is mostly used for learning high level behaviours \cite{louie2016learning} \cite{lockerd2004tutelage}. Our work fills this gap, by learning low level control of a social robot from demonstrations.
